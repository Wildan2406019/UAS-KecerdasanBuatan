...
## 9. Referensi
* Arifin, M. S., & nurcahyo, A. (2023). [Penerapan Algoritma Decision Tree untuk Klasifikasi Data Penjualan Produk Digital pada Platform Online](https://scholar.google.com/scholar?q=Penerapan+Algoritma+Decision+Tree+untuk+Klasifikasi+Data+Penjualan+Produk+Digital+pada+Platform+Online). *Jurnal Informatika dan Komputasi Kampus*, 11(2), 145-152.
* Breiman, L. (2017). [Classification and Regression Trees](https://scholar.google.com/scholar?q=Classification+and+Regression+Trees+Breiman). Routledge.
